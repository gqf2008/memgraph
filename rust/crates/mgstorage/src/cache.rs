...
pub struct QueryCache {
    inner:
        Mutex<LruCache<String, Arc<Vec<HashMap<String, mgcore::property_value::PropertyValue>>>>>,
    hits: Mutex<u64>,
    misses: Mutex<u64>,
}
...
impl QueryCache {
    ...
    pub fn get(
        &self,
        query: &str,
    ) -> Option<Arc<Vec<HashMap<String, mgcore::property_value::PropertyValue>>>> {
    ...
    pub fn put(
        &self,
        query: &str,
        result: Arc<Vec<HashMap<String, mgcore::property_value::PropertyValue>>>,
    ) {
...
impl PreparedStatementCache {
    ...
    pub fn get(&self, key: &str) -> Option<PreparedStatement> {
        ...
        stmts.get(key).cloned().inspect(|stmt| {

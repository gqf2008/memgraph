...
impl TextIndex {
    ...
    pub fn create(
        ...
        std::fs::create_dir_all(path.as_ref())
            .map_err(|e| tantivy::TantivyError::SystemError(format!("create_dir: {}", e)))?;
    ...
    pub fn search(
        ...
        query_str: &str,
        limit: usize,
    ) -> Result<Vec<(Gid, f32)>, tantivy::TantivyError> {
        self.reader.reload()?;
...
impl Default for TextIndexStore {
    fn default() -> Self {
        Self::new()
    }
}
...
impl TextIndexStore {
    ...
    pub fn create(
        ...
        path: impl AsRef<Path>,
        text_fields: &[String],
    ) -> Result<Arc<TextIndex>, tantivy::TantivyError> {
...
mod tests {
    ...
    fn test_search_data() {
        ...
        index
            .index_vertex(Gid::from(1u64), &[("name".into(), "Bob".into())])
            .unwrap();

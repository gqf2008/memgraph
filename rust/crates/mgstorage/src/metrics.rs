...
impl StorageMetrics {
    ...
    pub fn inc_vertices_created(&self, n: u64) { self.vertices_created.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_vertices_deleted(&self, n: u64) { self.vertices_deleted.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_vertices_updated(&self, n: u64) { self.vertices_updated.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_edges_created(&self, n: u64) { self.edges_created.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_edges_deleted(&self, n: u64) { self.edges_deleted.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_edges_updated(&self, n: u64) { self.edges_updated.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_properties_set(&self, n: u64) { self.properties_set.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_properties_removed(&self, n: u64) { self.properties_removed.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_labels_added(&self, n: u64) { self.labels_added.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_labels_removed(&self, n: u64) { self.labels_removed.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_transactions_committed(&self, n: u64) { self.transactions_committed.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_transactions_aborted(&self, n: u64) { self.transactions_aborted.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_gc_deltas(&self, n: u64) { self.gc_deltas_collected.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_ttl_expired(&self, n: u64) { self.ttl_vertices_expired.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_index_queries(&self, n: u64) { self.index_queries.fetch_add(n, Ordering::Relaxed); }
    pub fn inc_full_scans(&self, n: u64) { self.full_scans.fetch_add(n, Ordering::Relaxed); }
...
impl MetricsSnapshot {
    ...
    pub fn to_prometheus(&self) -> String {
        ...
        gauge!("vertices_created_total", "Total vertices created.", self.vertices_created);
        gauge!("vertices_deleted_total", "Total vertices deleted.", self.vertices_deleted);
        gauge!("edges_created_total", "Total edges created.", self.edges_created);
        gauge!("edges_deleted_total", "Total edges deleted.", self.edges_deleted);
        gauge!("transactions_committed_total", "Total committed transactions.", self.transactions_committed);
        gauge!("transactions_aborted_total", "Total aborted transactions.", self.transactions_aborted);
        gauge!("gc_deltas_collected_total", "Total GC deltas collected.", self.gc_deltas_collected);
        gauge!("ttl_vertices_expired_total", "Total TTL-expired vertices.", self.ttl_vertices_expired);
        gauge!("index_queries_total", "Total index queries.", self.index_queries);

...
impl ProcedureRegistry {
    pub fn new() -> Self {
        ...
        procs.insert(
            ...
            db_relationship_types as BuiltInProc,
        );
        procs.insert("db.schema".to_string(), db_schema as BuiltInProc);
        procs.insert(
            "db.schema.nodeTypeProperties".to_string(),
            db_schema_node_type_properties as BuiltInProc,
        );
        procs.insert(
            "db.schema.relTypeProperties".to_string(),
            db_schema_rel_type_properties as BuiltInProc,
        );
        ...
        procs.insert(
            "algo.triangle_count".to_string(),
            algo_triangle_count as BuiltInProc,
        );
        procs.insert(
            "algo.betweenness_centrality".to_string(),
            algo_betweenness_centrality as BuiltInProc,
        );
        procs.insert(
            "algo.closeness_centrality".to_string(),
            algo_closeness_centrality as BuiltInProc,
        );
        procs.insert(
            "algo.eigenvector_centrality".to_string(),
            algo_eigenvector_centrality as BuiltInProc,
        );
        procs.insert(
            "algo.shortest_path".to_string(),
            algo_shortest_path as BuiltInProc,
        );
        procs.insert(
            "algo.clustering_coefficient".to_string(),
            algo_clustering_coefficient as BuiltInProc,
        );
        procs.insert("algo.scc".to_string(), algo_scc as BuiltInProc);
        procs.insert(
            "algo.topological_sort".to_string(),
            algo_topological_sort as BuiltInProc,
        );
        procs.insert(
            "algo.degree_centrality".to_string(),
            algo_degree_centrality as BuiltInProc,
        );
        procs.insert("algo.bridges".to_string(), algo_bridges as BuiltInProc);
        procs.insert(
            "algo.is_bipartite".to_string(),
            algo_is_bipartite as BuiltInProc,
        );
        procs.insert("algo.diameter".to_string(), algo_diameter as BuiltInProc);
        procs.insert(
            "algo.graph_density".to_string(),
            algo_graph_density as BuiltInProc,
        );
        procs.insert("algo.has_cycle".to_string(), algo_has_cycle as BuiltInProc);
        procs.insert(
            "algo.harmonic_centrality".to_string(),
            algo_harmonic_centrality as BuiltInProc,
        );
        procs.insert("algo.radius".to_string(), algo_radius as BuiltInProc);
        procs.insert(
            "algo.eccentricity".to_string(),
            algo_eccentricity as BuiltInProc,
        );
        procs.insert(
            "algo.average_path_length".to_string(),
            algo_average_path_length as BuiltInProc,
        );
        procs.insert("algo.coreness".to_string(), algo_coreness as BuiltInProc);
        procs.insert(
            "algo.degree_assortativity".to_string(),
            algo_degree_assortativity as BuiltInProc,
        );
        procs.insert(
            "algo.global_clustering_coefficient".to_string(),
            algo_global_clustering_coefficient as BuiltInProc,
        );
        ...
        procs.insert(
            "algo.small_world_coefficient".to_string(),
            algo_small_world_coefficient as BuiltInProc,
        );
        procs.insert(
            "algo.articulation_points".to_string(),
            algo_articulation_points as BuiltInProc,
        );
        procs.insert(
            "algo.is_biconnected".to_string(),
            algo_is_biconnected as BuiltInProc,
        );
        procs.insert(
            "algo.connected_components".to_string(),
            algo_connected_components as BuiltInProc,
        );
        procs.insert(
            "algo.cycle_detection".to_string(),
            algo_cycle_detection as BuiltInProc,
        );
        procs.insert(
            "algo.all_pairs_shortest_path".to_string(),
            algo_all_pairs_shortest_path as BuiltInProc,
        );
        procs.insert(
            "algo.maximal_cliques".to_string(),
            algo_maximal_cliques as BuiltInProc,
        );
        procs.insert(
            "algo.clique_number".to_string(),
            algo_clique_number as BuiltInProc,
        );
        procs.insert(
            "algo.greedy_coloring".to_string(),
            algo_greedy_coloring as BuiltInProc,
        );
        procs.insert(
            "algo.dsatur_coloring".to_string(),
            algo_dsatur_coloring as BuiltInProc,
        );
        procs.insert(
            "algo.degeneracy".to_string(),
            algo_degeneracy as BuiltInProc,
        );
        procs.insert(
            "algo.predict_links".to_string(),
            algo_predict_links as BuiltInProc,
        );
        procs.insert(
            "algo.rich_club_coefficient".to_string(),
            algo_rich_club_coefficient as BuiltInProc,
        );
        procs.insert(
            "algo.katz_centrality".to_string(),
            algo_katz_centrality as BuiltInProc,
        );
        procs.insert(
            "algo.label_propagation".to_string(),
            algo_label_propagation as BuiltInProc,
        );
        procs.insert("algo.louvain".to_string(), algo_louvain as BuiltInProc);
        procs.insert("algo.hits".to_string(), algo_hits as BuiltInProc);
        procs.insert(
            "algo.core_decomposition".to_string(),
            algo_core_decomposition as BuiltInProc,
        );
        procs.insert("algo.k_core".to_string(), algo_k_core as BuiltInProc);
        procs.insert(
            "algo.floyd_warshall".to_string(),
            algo_floyd_warshall as BuiltInProc,
        );
        procs.insert(
            "algo.modularity".to_string(),
            algo_modularity as BuiltInProc,
        );
        procs.insert(
            "algo.conductance".to_string(),
            algo_conductance as BuiltInProc,
        );
        procs.insert(
            "algo.normalized_cut".to_string(),
            algo_normalized_cut as BuiltInProc,
        );
        procs.insert(
            "db.propertyKeys".to_string(),
            db_property_keys as BuiltInProc,
        );
        procs.insert(
            "db.createTextIndex".to_string(),
            db_create_text_index as BuiltInProc,
        );
        procs.insert(
            "db.searchTextIndex".to_string(),
            db_search_text_index as BuiltInProc,
        );
        procs.insert(
            "db.createVectorIndex".to_string(),
            db_create_vector_index as BuiltInProc,
        );
        procs.insert(
            "db.searchVectorIndex".to_string(),
            db_search_vector_index as BuiltInProc,
        );
        procs.insert(
            "db.createPointIndex".to_string(),
            db_create_point_index as BuiltInProc,
        );
        procs.insert(
            "db.dropPointIndex".to_string(),
            db_drop_point_index as BuiltInProc,
        );
...
fn db_labels(
    ...
    Ok(labels
        ...
        .map(|l| {
            ...
            row.insert(
                "label".to_string(),
                PropertyValue::String(format!("{}", l.as_uint())),
            );
            row
        })
        .collect())
    ...
    Ok(types
        ...
        .map(|t| {
            ...
            row.insert(
                ...
                PropertyValue::String(format!("{}", t.as_uint())),
            );
            row
        })
        .collect())
...
fn db_schema(
    ...
    row.insert(
        "nodeCount".to_string(),
        PropertyValue::Int(storage.vertex_count() as i64),
    );
    row.insert(
        "relationshipCount".to_string(),
        PropertyValue::Int(storage.edge_count() as i64),
    );
    row.insert(
        "labelCount".to_string(),
        PropertyValue::Int(labels.len() as i64),
    );
    row.insert(
        "relTypeCount".to_string(),
        PropertyValue::Int(edge_types.len() as i64),
    );
    Ok(vec![row])
}
...
fn db_schema_node_type_properties(
    ...
    for label in storage.schema_info.all_labels() {
        ...
        for prop in props {
            ...
            row.insert(
                "nodeType".to_string(),
                PropertyValue::String(format!("{}", label.as_uint())),
            );
            row.insert(
                "propertyName".to_string(),
                PropertyValue::String(format!("{}", prop.as_uint())),
            );
            rows.push(row);
        }
    }
...
fn db_schema_rel_type_properties(
    ...
    for etype in storage.schema_info.all_edge_types() {
        ...
        for prop in props {
            ...
            row.insert(
                "relType".to_string(),
                PropertyValue::String(format!("{}", etype.as_uint())),
            );
            row.insert(
                "propertyName".to_string(),
                PropertyValue::String(format!("{}", prop.as_uint())),
...
fn db_stats(
    ...
    let mut row = HashMap::new();
    row.insert(
        "verticesCreated".to_string(),
        PropertyValue::Int(snap.vertices_created as i64),
    );
    row.insert(
        "verticesDeleted".to_string(),
        PropertyValue::Int(snap.vertices_deleted as i64),
    );
    row.insert(
        "edgesCreated".to_string(),
        PropertyValue::Int(snap.edges_created as i64),
    );
    row.insert(
        "edgesDeleted".to_string(),
        PropertyValue::Int(snap.edges_deleted as i64),
    );
    row.insert(
        "transactionsCommitted".to_string(),
        PropertyValue::Int(snap.transactions_committed as i64),
    );
    row.insert(
        "transactionsAborted".to_string(),
        PropertyValue::Int(snap.transactions_aborted as i64),
    );
    Ok(vec![row])
}
...
fn db_indexes(
    ...
    for (label, prop) in lp.iter() {
        ...
        row.insert(
            "type".to_string(),
            PropertyValue::String("label+property".into()),
        );
        rows.push(row);
    }
    // Vector indices
    let vector_indices = storage
        .vector_indices
        .read()
        .map_err(|e| format!("{}", e))?;
    for (label, entry) in vector_indices.iter() {
        ...
        row.insert(
            "property".to_string(),
            PropertyValue::String(format!("{}", entry.property.as_uint())),
        );
        row.insert("type".to_string(), PropertyValue::String("vector".into()));
        row.insert(
            "dimension".to_string(),
            PropertyValue::Int(entry.dimension as i64),
        );
        row.insert(
            "distance".to_string(),
            PropertyValue::String(format!("{:?}", entry.distance)),
        );
        rows.push(row);
    }
    drop(vector_indices);
    ...
    for (label, entry) in text_indices.iter() {
        ...
        let prop_names: Vec<String> = entry
            .properties
            .iter()
            .map(|(pid, _)| format!("{}", pid.as_uint()))
            .collect();
        row.insert(
            "property".to_string(),
            PropertyValue::String(prop_names.join(",")),
        );
...
fn db_constraints(
    ...
    for c in &storage.constraints.list() {
        ...
        row.insert(
            "type".to_string(),
            PropertyValue::String(format!("{:?}", c.kind)),
        );
        row.insert(
            "label".to_string(),
            PropertyValue::String(format!("{}", c.label.as_uint())),
        );
        row.insert(
            "property".to_string(),
            PropertyValue::String(format!("{}", c.property.as_uint())),
        );
        rows.push(row);
    }
    Ok(rows)
...
fn algo_is_bipartite(
    ...
    row.insert(
        "bipartite".to_string(),
        PropertyValue::Bool(mgquery::is_bipartite(storage)),
    );
    Ok(vec![row])
}
...
fn algo_diameter(
    ...
    row.insert(
        "diameter".to_string(),
        PropertyValue::Int(mgquery::diameter(storage) as i64),
    );
    Ok(vec![row])
}
...
fn algo_graph_density(
    ...
    row.insert(
        "density".to_string(),
        PropertyValue::Double(mgquery::graph_density(storage)),
    );
    Ok(vec![row])
}
...
fn algo_has_cycle(
    ...
    row.insert(
        "hasCycle".to_string(),
        PropertyValue::Bool(mgquery::has_cycle(storage)),
    );
    Ok(vec![row])
}
...
fn algo_radius(
    ...
    row.insert(
        "radius".to_string(),
        PropertyValue::Int(mgquery::radius(storage) as i64),
    );
    Ok(vec![row])
}
...
fn algo_average_path_length(
    ...
    let mut row = HashMap::new();
    row.insert(
        "averagePathLength".to_string(),
        PropertyValue::Double(mgquery::average_path_length(storage)),
    );
    Ok(vec![row])
}
...
fn algo_degree_assortativity(
    ...
    row.insert(
        ...
        PropertyValue::Double(mgquery::degree_assortativity(storage)),
    );
    Ok(vec![row])
}
...
fn algo_global_clustering_coefficient(
    ...
    let mut row = HashMap::new();
    row.insert(
        "globalClusteringCoefficient".to_string(),
        PropertyValue::Double(mgquery::global_clustering_coefficient(storage)),
    );
    Ok(vec![row])
}
...
fn algo_small_world_coefficient(
    ...
    row.insert(
        "sigma".to_string(),
        PropertyValue::Double(mgquery::small_world_coefficient(storage)),
    );
    Ok(vec![row])
}
...
fn algo_is_biconnected(
    ...
    let mut row = HashMap::new();
    row.insert(
        "biconnected".to_string(),
        PropertyValue::Bool(mgquery::articulation_points::is_biconnected(storage)),
    );
    Ok(vec![row])
}
        ...
        .map(|(i, clique)| {
            ...
            row.insert(
                ...
                PropertyValue::List(
                    clique
                        .into_iter()
                        .map(|g| PropertyValue::Int(g.as_int()))
                        .collect(),
                ),
            );
            row
...
fn algo_clique_number(
    ...
    let mut row = HashMap::new();
    row.insert(
        "cliqueNumber".to_string(),
        PropertyValue::Int(mgquery::clique::clique_number(storage) as i64),
    );
    Ok(vec![row])
}
...
fn algo_degeneracy(
    ...
    row.insert(
        ...
        PropertyValue::Int(mgquery::k_core::degeneracy(storage) as i64),
    );
    Ok(vec![row])
}
...
fn algo_hits(
    ...
    Ok(auth
        ...
        .map(|(gid, score)| {
            ...
            row.insert(
                "hub".to_string(),
                PropertyValue::Double(hub.get(&gid).copied().unwrap_or(0.0)),
            );
            row
        })
        .collect())
...
pub fn db_create_text_index(
    ...
    let path = format!("/tmp/mg_text_idx_{}_{}_{}", label_name, pid, unique);
...
pub fn db_create_vector_index(
    ...
    let entry =
        mgstorage::storage::VectorIndexEntry::new(index.clone(), prop_id, dimension, distance);
...
pub fn db_search_vector_index(
    ...
    Ok(results
        ...
        .map(|(node_id, distance)| {
            ...
            row.insert(
                "distance".to_string(),
                PropertyValue::Double(distance as f64),
            );
            row
        })
        .collect())
        ...
        if labels.contains(&label_id) {
            ...
            match prop_value {
                PropertyValue::Point2D(p) => {
                    storage.point_index.insert_2d(label_id, prop_id, gid, *p)
                }
                PropertyValue::Point3D(p) => {
                    storage.point_index.insert_3d(label_id, prop_id, gid, *p)
                }
                _ => {}
            }
        }
...
pub fn db_within_bbox(
    ...
    let gids = storage
        .point_index
        .within_bbox_2d(label_id, prop_id, lower_left, upper_right);
    Ok(gids
        .into_iter()
        .map(|gid| {
            let mut row = HashMap::new();
...
pub fn db_nearest(
    ...
    let results = storage
        .point_index
        .nearest_2d(label_id, prop_id, query_point, k);
    Ok(results
        .into_iter()
        .map(|(gid, distance)| {
            let mut row = HashMap::new();
...
fn db_analytics(
    ...
    row.insert(
        ...
        PropertyValue::Int(stats.vertex_count as i64),
    );
    row.insert(
        "edgeCount".to_string(),
        PropertyValue::Int(stats.edge_count as i64),
    );
    row.insert(
        "avgDegree".to_string(),
        PropertyValue::Double(stats.avg_degree),
    );
    row.insert(
        "maxInDegree".to_string(),
        PropertyValue::Int(stats.max_in_degree as i64),
    );
    row.insert(
        "maxOutDegree".to_string(),
        PropertyValue::Int(stats.max_out_degree as i64),
    );
    row.insert("density".to_string(), PropertyValue::Double(stats.density));
    row.insert(
        "connectedComponents".to_string(),
        PropertyValue::Int(stats.connected_component_count as i64),
    );
    row.insert(
        "isolatedVertices".to_string(),
        PropertyValue::Int(stats.isolated_vertex_count as i64),
    );
    row.insert(
        "avgClusteringCoefficient".to_string(),
        PropertyValue::Double(avg_cc),
    );
    row.insert(
        "reciprocity".to_string(),
        PropertyValue::Double(reciprocity),
    );
    row.insert(
        "triangleDensity".to_string(),
        PropertyValue::Double(triangle_density),
    );
    row.insert(
        "degreeCorrelation".to_string(),

...
impl<'a> Lexer<'a> {
    ...
    fn keyword_or_identifier(s: &str) -> Token {
        ...
        if s.eq_ignore_ascii_case("OPTIONAL") {
            return Token::Optional;
        }
        if s.eq_ignore_ascii_case("CREATE") {
            return Token::Create;
        }
        if s.eq_ignore_ascii_case("MERGE") {
            return Token::Merge;
        }
        if s.eq_ignore_ascii_case("DELETE") {
            return Token::Delete;
        }
        if s.eq_ignore_ascii_case("DETACH") {
            return Token::Detach;
        }
        ...
        if s.eq_ignore_ascii_case("UNWIND") {
            return Token::Unwind;
        }
        ...
        if s.eq_ignore_ascii_case("REDUCE") {
            return Token::Reduce;
        }
        ...
        if s.eq_ignore_ascii_case("THEN") {
            return Token::Then;
        }
        ...
        if s.eq_ignore_ascii_case("FOREACH") {
            return Token::Foreach;
        }
        if s.eq_ignore_ascii_case("CALL") {
            return Token::Call;
        }
        if s.eq_ignore_ascii_case("YIELD") {
            return Token::Yield;
        }
        ...
        if s.eq_ignore_ascii_case("STARTS") {
        ...
        if s.eq_ignore_ascii_case("HEADERS") {
        ...
        if s.eq_ignore_ascii_case("ASSERT") {
            return Token::Assert;
        }
        if s.eq_ignore_ascii_case("UNIQUE") {
            return Token::Unique;
        }
        if s.eq_ignore_ascii_case("TYPED") {
            return Token::Typed;
        }
        if s.eq_ignore_ascii_case("EXPLAIN") {
            return Token::Explain;
        }
        if s.eq_ignore_ascii_case("PROFILE") {
            return Token::Profile;
        }
        if s.eq_ignore_ascii_case("USER") {
            return Token::User;
        }
        if s.eq_ignore_ascii_case("ROLE") {
            return Token::Role;
        }
        if s.eq_ignore_ascii_case("GRANT") {
            return Token::Grant;
        }
        if s.eq_ignore_ascii_case("REVOKE") {
            return Token::Revoke;
        }
        if s.eq_ignore_ascii_case("TO") {
            return Token::To;
        }
        if s.eq_ignore_ascii_case("IDENTIFIED") {
            return Token::Identified;
        }
        if s.eq_ignore_ascii_case("PASSWORD") {
            return Token::Password;
        }
        if s.eq_ignore_ascii_case("TRIGGER") {
        ...
        if s.eq_ignore_ascii_case("EXECUTE") {
            return Token::Execute;
        }
        if s.eq_ignore_ascii_case("VERTEX") {
            return Token::Vertex;
        }
        ...
        if s.eq_ignore_ascii_case("FORCE") {
            return Token::Force;
        }
        if s.eq_ignore_ascii_case("BFS") {
            return Token::Bfs;
        }
        if s.eq_ignore_ascii_case("WSHORTEST") {
            return Token::WShortest;
        }
        if s.eq_ignore_ascii_case("ALLSHORTEST") {
            return Token::AllShortest;
        }
        if s.eq_ignore_ascii_case("KSHORTEST") {
            return Token::KShortest;
        }
        if s.eq_ignore_ascii_case("SHORTESTPATH") {
            return Token::ShortestPath;
        }
        if s.eq_ignore_ascii_case("ALLSHORTESTPATHS") {
            return Token::AllShortestPaths;
        }
        if s.eq_ignore_ascii_case("USING") {
            return Token::Using;
        }
        if s.eq_ignore_ascii_case("PERIODIC") {
            return Token::Periodic;
        }
        if s.eq_ignore_ascii_case("COMMIT") {
            return Token::Commit;
        }
        if s.eq_ignore_ascii_case("TRANSACTIONS") {
        ...
        if s.eq_ignore_ascii_case("SETTING") {
            return Token::Setting;
        }
        if s.eq_ignore_ascii_case("SETTINGS") {
            return Token::Settings;
        }
        if s.eq_ignore_ascii_case("TERMINATE") {
        ...
        if s.eq_ignore_ascii_case("PRIVILEGE") {
            return Token::Privilege;
        }
        if s.eq_ignore_ascii_case("PRIVILEGES") {
        ...
        if s.eq_ignore_ascii_case("ANALYTICAL") {
            return Token::Analytical;
        }
        if s.eq_ignore_ascii_case("TRANSACTIONAL") {
            return Token::Transactional;
        }
        if s.eq_ignore_ascii_case("ON_DISK") {
            return Token::OnDisk;
        }
        if s.eq_ignore_ascii_case("IN_MEMORY") {
            return Token::InMemory;
        }
        if s.eq_ignore_ascii_case("IN_MEMORY_ANALYTICAL") {
            return Token::InMemoryAnalytical;
        }
        if s.eq_ignore_ascii_case("IN_MEMORY_TRANSACTIONAL") {
            return Token::InMemoryTransactional;
        }
        if s.eq_ignore_ascii_case("ON_DISK_TRANSACTIONAL") {
            return Token::OnDiskTransactional;
        }
        if s.eq_ignore_ascii_case("FOR") {
            return Token::For;
        }

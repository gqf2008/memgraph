...
impl Fingerprint for IndexHint {
    fn fingerprint(&self) -> u64 {
        ...
        self.property.map(u32::from).hash(&mut h);
        h.finish()
    }
}
...
pub enum Clause {
    ...
    LoadJsonl { url: String, alias: String },
    ...
    /// DROP ROLE name
    DropRole { role_name: String },
    /// GRANT role TO user
    GrantRole { role_name: String, username: String },
    /// REVOKE role FROM user
    RevokeRole { role_name: String, username: String },
    /// SHOW USERS | ROLES
    ShowAuth { auth_type: ShowAuthType },
    ...
    DropDatabase { name: String, force: bool },
    /// SHOW DATABASE SETTING name
    ShowSetting { name: String },
    /// SHOW DATABASE SETTINGS
    ShowSettings,
    /// SET SETTING name TO value
    SetSetting { name: String, value: Expression },
    /// SHOW TRANSACTIONS
    ShowTransactions,
    /// TERMINATE TRANSACTIONS id
    TerminateTransaction { transaction_id: String },
    ...
    ShowPrivileges { target_name: String, is_user: bool },
...
impl Privilege {
    ...
    pub fn all() -> Vec<Privilege> {
        vec![
            ...
            Self::MultiDatabaseEdit,
            Self::MultiDatabaseUse,
            Self::Coordinator,
            Self::ImpersonateUser,
            Self::ProfileRestriction,
            Self::ParallelExecution,
            Self::ServerSideParameters,
            Self::ServerSideDescriptions,
        ]
    }
}
...
pub enum SetItem {
    ...
    /// n:Label
    Label { alias: String, label: LabelId },
}

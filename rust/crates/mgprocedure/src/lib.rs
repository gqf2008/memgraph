...
pub type MgpProcCb =
    unsafe extern "C" fn(*mut mgp_list, *mut mgp_graph, *mut mgp_result, *mut mgp_memory);
/// Function callback signature.
pub type MgpFuncCb =
    unsafe extern "C" fn(*mut mgp_list, *mut mgp_graph, *mut mgp_func_result, *mut mgp_memory);
...
#[repr(C)]
pub struct mgp_label {
    pub name: *const c_char,
}

#[repr(C)]
pub struct mgp_edge_type {
    pub name: *const c_char,
}

#[repr(C)]
#[derive(Clone, Copy, Default)]
pub struct mgp_vertex_id {
    pub as_int: i64,
}

#[repr(C)]
#[derive(Clone, Copy, Default)]
pub struct mgp_edge_id {
    pub as_int: i64,
}
...
#[no_mangle]
pub unsafe extern "C" fn mgp_alloc(
    ...
    if p.is_null() && size != 0 {
        return MgpError::UnableToAllocate;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_global_aligned_alloc(
    size: usize,
    alignment: usize,
    result: *mut *mut c_void,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_null(
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_bool(
    val: i32,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_int(
    val: i64,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_double(
    val: f64,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_string(
    val: *const c_char,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_list(
    list: *mut mgp_list,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_map(
    map: *mut mgp_map,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_vertex(
    v: *mut mgp_vertex,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_edge(
    e: *mut mgp_edge,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_path(
    p: *mut mgp_path,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_date(
    days: i64,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_local_time(
    us: i64,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_local_date_time(
    us: i64,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_duration(
    months: i64,
    days: i64,
    micros: i64,
    _memory: *mut mgp_memory,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_point_2d(
    crs: u16,
    x: f64,
    y: f64,
    _memory: *mut mgp_memory,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_point_3d(
    crs: u16,
    x: f64,
    y: f64,
    z: f64,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_copy(
    val: *const mgp_value,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_type(
    val: *const mgp_value,
    result: *mut MgpValueType,
) -> MgpError {
    if val.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
is_variant!(
    mgp_value_is_zoned_date_time,
    ValueInner::ZonedDateTime { .. }
);
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_string(
    val: *const mgp_value,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_list(
    val: *const mgp_value,
    result: *mut *const mgp_list,
) -> MgpError {
    if val.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_map(
    val: *const mgp_value,
    result: *mut *const mgp_map,
) -> MgpError {
    if val.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_vertex(
    val: *const mgp_value,
    result: *mut *const mgp_vertex,
) -> MgpError {
    if val.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_edge(
    val: *const mgp_value,
    result: *mut *const mgp_edge,
) -> MgpError {
    if val.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_path(
    val: *const mgp_value,
    result: *mut *const mgp_path,
) -> MgpError {
    if val.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_local_time(
    val: *const mgp_value,
    result: *mut i64,
) -> MgpError {
    if val.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_local_date_time(
    val: *const mgp_value,
    result: *mut i64,
) -> MgpError {
    if val.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_duration(
    val: *const mgp_value,
    result: *mut *mut mgp_duration,
) -> MgpError {
    if val.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    match (*val).inner {
        ValueInner::Duration {
            ...
            let d = Box::into_raw(Box::new(mgp_duration {
                months,
                days,
                micros,
            }));
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_zoned_date_time(
    val: *const mgp_value,
    result: *mut *mut mgp_zoned_date_time,
) -> MgpError {
    if val.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_point_2d(
    val: *const mgp_value,
    result: *mut *mut mgp_point_2d,
) -> MgpError {
    if val.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_point_3d(
    val: *const mgp_value,
    result: *mut *mut mgp_point_3d,
) -> MgpError {
    if val.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_get_enum(
    val: *const mgp_value,
    result: *mut *mut mgp_enum,
) -> MgpError {
    if val.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_zoned_date_time(
    micros: i64,
    offset: i16,
    tz: *const c_char,
    _memory: *mut mgp_memory,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_value_make_enum(
    enum_type: *const c_char,
    value: *const c_char,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if enum_type.is_null() || value.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_list_make_empty(
    capacity: usize,
    _memory: *mut mgp_memory,
    ...
    *result = Box::into_raw(Box::new(mgp_list {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_list_append_extend(
    list: *mut mgp_list,
    val: *mut mgp_value,
) -> MgpError {
...
pub unsafe extern "C" fn mgp_list_size(list: *const mgp_list, result: *mut usize) -> MgpError {
    if list.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_list_at(
    list: *const mgp_list,
    index: usize,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_list_append_move(
    list: *mut mgp_list,
    val: *mut mgp_value,
) -> MgpError {
    mgp_list_append(list, val)
...
#[no_mangle]
pub unsafe extern "C" fn mgp_list_copy(
    list: *mut mgp_list,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_list,
) -> MgpError {
    ...
    for item in &(*list).items {
        new_list
            .items
            .push(mgp_value::boxed((**item).inner.clone()));
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_list_contains_deleted(
    _list: *const mgp_list,
    result: *mut i32,
) -> MgpError {
    if result.is_null() {
        return MgpError::InvalidArgument;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_make_empty(
    _memory: *mut mgp_memory,
    ...
    *result = Box::into_raw(Box::new(mgp_map {
        items: HashMap::new(),
    }));
    MgpError::NoError
}
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_insert(
    map: *mut mgp_map,
    key: *const c_char,
    val: *mut mgp_value,
) -> MgpError {
    ...
    if (*map).items.contains_key(&k) {
        return MgpError::KeyAlreadyExists;
    }
    let cloned = mgp_value::boxed((*val).inner.clone());
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_update(
    map: *mut mgp_map,
    key: *const c_char,
    val: *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_at(
    map: *const mgp_map,
    key: *const c_char,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_key_exists(
    map: *const mgp_map,
    key: *const c_char,
    result: *mut i32,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_copy(
    map: *mut mgp_map,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_map,
) -> MgpError {
    ...
    for (k, v) in &(*map).items {
        ...
        new_map
            .items
            .insert(CString::new(k.to_bytes()).unwrap_or_default(), cloned);
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_contains_deleted(
    _map: *const mgp_map,
    result: *mut i32,
) -> MgpError {
    if result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_insert_move(
    map: *mut mgp_map,
    key: *const c_char,
    val: *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_update_move(
    map: *mut mgp_map,
    key: *const c_char,
    val: *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_iter_items(
    map: *mut mgp_map,
    result: *mut *mut mgp_map_items_iterator,
) -> MgpError {
    if map.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_items_iterator_get(
    it: *mut mgp_map_items_iterator,
    result: *mut *mut mgp_map_item,
) -> MgpError {
    if it.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    let it = &mut *it;
    ...
    it.pos += 1;
    let item = Box::into_raw(Box::new(mgp_map_item {
        key: key.as_ptr(),
        value,
    }));
    *result = item;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_items_iterator_next(
    it: *mut mgp_map_items_iterator,
    result: *mut *mut mgp_map_item,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_item_key(
    item: *mut mgp_map_item,
    result: *mut *const c_char,
) -> MgpError {
    if item.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    *result = (*item).key;
    MgpError::NoError
...
#[no_mangle]
pub unsafe extern "C" fn mgp_map_item_value(
    item: *mut mgp_map_item,
    result: *mut *mut mgp_value,
) -> MgpError {
    if item.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_memory_tracked_bytes(
    memory: *const mgp_memory,
    result: *mut usize,
) -> MgpError {
    if result.is_null() {
        return MgpError::InvalidArgument;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_graph_is_transactional(
    _g: *const mgp_graph,
    result: *mut i32,
) -> MgpError {
    if result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_graph_approximate_vertex_count(
    g: *const mgp_graph,
    result: *mut u64,
) -> MgpError {
    if result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_graph_approximate_edge_count(
    g: *const mgp_graph,
    result: *mut u64,
) -> MgpError {
    if result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_graph_has_text_index(
    _g: *const mgp_graph,
    _name: *const c_char,
    result: *mut i32,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_graph_iter_vertices(
    g: *mut mgp_graph,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_vertices_iterator,
) -> MgpError {
    if g.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    let storage = &*(*g).storage;
    let keys: Vec<u64> = storage
        .all_vertices()
        .iter()
        .map(|(gid, _, _)| gid.as_uint())
        .collect();
    *result = Box::into_raw(Box::new(mgp_vertices_iterator {
        graph: g,
        keys,
        pos: 0,
    }));
...
#[no_mangle]
pub unsafe extern "C" fn mgp_graph_get_vertex_by_id(
    g: *mut mgp_graph,
    id: mgp_vertex_id,
    _memory: *mut mgp_memory,
    ...
    if storage.get_vertex(gid, tx).is_some() {
        *result = Box::into_raw(Box::new(mgp_vertex {
            gid: id.as_int as u64,
            graph: g,
        }));
        MgpError::NoError
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_graph_create_vertex(
    g: *mut mgp_graph,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_vertex,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_get_id(
    v: *const mgp_vertex,
    result: *mut mgp_vertex_id,
) -> MgpError {
    if v.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    *result = mgp_vertex_id {
        as_int: (*v).gid as i64,
    };
    MgpError::NoError
}
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_copy(
    v: *mut mgp_vertex,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_vertex,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_labels_count(
    v: *const mgp_vertex,
    result: *mut usize,
) -> MgpError {
    if v.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_has_label(
    v: *const mgp_vertex,
    label: mgp_label,
    result: *mut i32,
) -> MgpError {
    ...
    match storage.get_vertex(gid, tx) {
        Some(snap) => {
            *result = if snap.labels.contains(&label_id) {
                1
            } else {
                0
            };
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_has_label_named(
    v: *const mgp_vertex,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_label_at(
    v: *const mgp_vertex,
    idx: usize,
    result: *mut mgp_label,
) -> MgpError {
    if v.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
pub unsafe extern "C" fn mgp_vertex_is_deleted(v: *const mgp_vertex, result: *mut i32) -> MgpError {
    ...
    let gid = (*v).gid;
    let gid = Gid::from(gid);
    *result = if storage.get_vertex(gid, tx).is_some() {
        0
    } else {
        1
    };
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_equal(
    v1: *const mgp_vertex,
    v2: *const mgp_vertex,
    result: *mut i32,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_underlying_graph_is_mutable(
    _v: *const mgp_vertex,
    result: *mut i32,
) -> MgpError {
    if result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_get_in_degree(
    v: *const mgp_vertex,
    result: *mut usize,
) -> MgpError {
    if v.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_get_out_degree(
    v: *const mgp_vertex,
    result: *mut usize,
) -> MgpError {
    if v.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_iter_in_edges(
    v: *const mgp_vertex,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_edges_iterator,
) -> MgpError {
    if v.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    ...
    let gid = Gid::from((*v).gid);
    let keys: Vec<u64> = storage
        .vertex_in_edge_gids(gid)
        .iter()
        .map(|g| g.as_uint())
        .collect();
    *result = Box::into_raw(Box::new(mgp_edges_iterator {
        graph,
        keys,
        pos: 0,
    }));
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_iter_out_edges(
    v: *const mgp_vertex,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_edges_iterator,
) -> MgpError {
...
fn property_value_to_mgp_value(pv: &PropertyValue) -> *mut mgp_value {
    let inner = match pv {
        ...
        PropertyValue::String(s) => {
            ValueInner::String(CString::new(s.as_str()).unwrap_or_default())
        }
        ...
        PropertyValue::Map(entries) => {
            let map = Box::into_raw(Box::new(mgp_map {
                items: HashMap::new(),
            }));
            for (k, v) in entries {
        ...
        PropertyValue::Point2D(p) => ValueInner::Point2D {
            crs: p.crs as u16,
            x: p.x,
            y: p.y,
        },
        PropertyValue::Point3D(p) => ValueInner::Point3D {
            crs: p.crs as u16,
            x: p.x,
            y: p.y,
            z: p.z,
...
unsafe fn mgp_value_to_property_value(val: *const mgp_value) -> Option<PropertyValue> {
    ...
    Some(match &(*val).inner {
        ...
        ValueInner::List(list) => {
            let items: Vec<PropertyValue> = (**list)
                .items
                .iter()
        ...
        ValueInner::LocalDateTime(us) => {
            PropertyValue::LocalDateTime(LocalDateTime::from_microseconds(*us))
        }
        ValueInner::Duration {
            months,
            days,
            micros,
        } => PropertyValue::Duration(Duration::new(*months, *days, *micros)),
        ValueInner::ZonedDateTime { micros, offset, tz } => PropertyValue::ZonedDateTime(
            ZonedDateTime::new(*micros, *offset, tz.to_string_lossy().into_owned()),
        ),
        ValueInner::Point2D { crs, x, y } => {
            let crs = match *crs {
                4326 => Crs::WGS84,
...
unsafe fn graph_catalog(graph: *const mgp_graph) -> &'static mgcatalog::Catalog {
    if !graph.is_null() && !(*graph).catalog.is_null() {
        ...
        static GLOBAL_CATALOG: LazyLock<mgcatalog::Catalog> =
            LazyLock::new(mgcatalog::Catalog::new);
        &GLOBAL_CATALOG
    }
}

#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_iter_properties(
    v: *const mgp_vertex,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_properties_iterator,
) -> MgpError {
    if v.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
pub unsafe extern "C" fn mgp_vertex_get_property(
    ...
    if v.is_null() || name.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    let graph = (*v).graph;
    if graph.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_edge_copy(
    e: *mut mgp_edge,
    _memory: *mut mgp_memory,
    ...
    *result = Box::into_raw(Box::new(mgp_edge {
        gid: (*e).gid,
        graph: (*e).graph,
    }));
    MgpError::NoError
...
#[no_mangle]
pub unsafe extern "C" fn mgp_edge_get_type(
    e: *const mgp_edge,
    result: *mut mgp_edge_type,
) -> MgpError {
    if e.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_edge_get_from(
    e: *const mgp_edge,
    result: *mut *mut mgp_vertex,
) -> MgpError {
    if e.is_null() || result.is_null() {
    ...
    match storage.get_edge(gid, tx) {
        Some(snap) => {
            let v = Box::into_raw(Box::new(mgp_vertex {
                gid: snap.from_vertex.as_uint(),
                graph,
            }));
            *result = v;
            MgpError::NoError
...
#[no_mangle]
pub unsafe extern "C" fn mgp_edge_get_to(
    e: *const mgp_edge,
    result: *mut *mut mgp_vertex,
) -> MgpError {
    if e.is_null() || result.is_null() {
...
pub unsafe extern "C" fn mgp_edge_is_deleted(e: *const mgp_edge, result: *mut i32) -> MgpError {
    ...
    let gid = (*e).gid;
    let gid = Gid::from(gid);
    *result = if storage.get_edge(gid, tx).is_some() {
        0
    } else {
        1
    };
...
#[no_mangle]
pub unsafe extern "C" fn mgp_edge_equal(
    e1: *const mgp_edge,
    e2: *const mgp_edge,
    result: *mut i32,
) -> MgpError {
    if e1.is_null() || e2.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_edge_underlying_graph_is_mutable(
    _e: *const mgp_edge,
    result: *mut i32,
) -> MgpError {
    if result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_edge_iter_properties(
    e: *mut mgp_edge,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_properties_iterator,
) -> MgpError {
...
pub unsafe extern "C" fn mgp_edge_get_property(
    ...
    if e.is_null() || name.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    let graph = (*e).graph;
    if graph.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertices_iterator_get(
    it: *mut mgp_vertices_iterator,
    result: *mut *const mgp_vertex,
) -> MgpError {
    if it.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertices_iterator_next(
    it: *mut mgp_vertices_iterator,
    result: *mut *const mgp_vertex,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertices_iterator_underlying_graph_is_mutable(
    _it: *const mgp_vertices_iterator,
    result: *mut i32,
) -> MgpError {
    if result.is_null() {
        return MgpError::InvalidArgument;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_edges_iterator_get(
    it: *mut mgp_edges_iterator,
    result: *mut *const mgp_edge,
) -> MgpError {
    if it.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    ...
    let gid = it.keys[it.pos];
    it.pos += 1;
    let e = Box::into_raw(Box::new(mgp_edge {
        gid,
        graph: it.graph,
    }));
    *result = e;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_edges_iterator_next(
    it: *mut mgp_edges_iterator,
    result: *mut *const mgp_edge,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_edges_iterator_underlying_graph_is_mutable(
    _it: *const mgp_edges_iterator,
    result: *mut i32,
) -> MgpError {
    if result.is_null() {
        return MgpError::InvalidArgument;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_properties_iterator_get(
    it: *mut mgp_properties_iterator,
    result: *mut *mut mgp_property,
) -> MgpError {
    if it.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_properties_iterator_next(
    it: *mut mgp_properties_iterator,
    result: *mut *mut mgp_property,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_path_vertex_at(
    p: *const mgp_path,
    index: usize,
    result: *mut *mut mgp_vertex,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_path_edge_at(
    p: *const mgp_path,
    index: usize,
    result: *mut *mut mgp_edge,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_path_equal(
    p1: *const mgp_path,
    p2: *const mgp_path,
    result: *mut i32,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_path_contains_deleted(
    p: *const mgp_path,
    result: *mut i32,
) -> MgpError {
    if p.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_path_copy(
    p: *mut mgp_path,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_path,
) -> MgpError {
    if p.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_path_make_with_start(
    v: *mut mgp_vertex,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_path,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_set_property(
    v: *mut mgp_vertex,
    name: *const c_char,
    val: *mut mgp_value,
) -> MgpError {
    if v.is_null() || name.is_null() || val.is_null() {
        return MgpError::InvalidArgument;
    }
    let graph = (*v).graph;
    if graph.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_vertex_set_properties(
    v: *mut mgp_vertex,
    properties: *mut mgp_map,
) -> MgpError {
    if v.is_null() || properties.is_null() {
        return MgpError::InvalidArgument;
    }
    let graph = (*v).graph;
    if graph.is_null() {
    ...
    for (key_cstr, val_ptr) in &(*properties).items {
        ...
        if storage
            .vertex_set_property(tx, gid, property_id, pv)
            .is_err()
        {
            return MgpError::LogicError;
        }
...
pub unsafe extern "C" fn mgp_vertex_add_label(v: *mut mgp_vertex, label: mgp_label) -> MgpError {
    if v.is_null() || label.name.is_null() {
        return MgpError::InvalidArgument;
    }
    let graph = (*v).graph;
    if graph.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_edge_set_property(
    e: *mut mgp_edge,
    name: *const c_char,
    val: *mut mgp_value,
) -> MgpError {
    if e.is_null() || name.is_null() || val.is_null() {
        return MgpError::InvalidArgument;
    }
    let graph = (*e).graph;
    if graph.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_edge_set_properties(
    e: *mut mgp_edge,
    properties: *mut mgp_map,
) -> MgpError {
    if e.is_null() || properties.is_null() {
        return MgpError::InvalidArgument;
    }
    let graph = (*e).graph;
    if graph.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_graph_create_edge(
    g: *mut mgp_graph,
    from: *mut mgp_vertex,
    to: *mut mgp_vertex,
    ty: mgp_edge_type,
    ...
    if g.is_null() || from.is_null() || to.is_null() || ty.name.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    let storage = &mut *((*g).storage as *mut Storage);
    let tx = &*(*g).tx;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_graph_delete_vertex(
    g: *mut mgp_graph,
    v: *mut mgp_vertex,
) -> MgpError {
    if g.is_null() || v.is_null() {
        return MgpError::InvalidArgument;
    }
    let storage = &mut *((*g).storage as *mut Storage);
    let tx = &*(*g).tx;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_graph_detach_delete_vertex(
    g: *mut mgp_graph,
    v: *mut mgp_vertex,
) -> MgpError {
    if g.is_null() || v.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_date_now(
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if result.is_null() {
...
pub unsafe extern "C" fn mgp_date_get_year(date: *mut mgp_date, result: *mut i64) -> MgpError {
    if date.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    let days = (*date).days;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_now(
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_get_hour(
    time: *mut mgp_local_time,
    result: *mut i64,
) -> MgpError {
    if time.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_get_minute(
    time: *mut mgp_local_time,
    result: *mut i64,
) -> MgpError {
    if time.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_get_second(
    time: *mut mgp_local_time,
    result: *mut i64,
) -> MgpError {
    if time.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_get_microsecond(
    time: *mut mgp_local_time,
    result: *mut i64,
) -> MgpError {
    if time.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_get_millisecond(
    time: *mut mgp_local_time,
    result: *mut i64,
) -> MgpError {
    if time.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_timestamp(
    time: *mut mgp_local_time,
    result: *mut i64,
) -> MgpError {
    if time.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_now(
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_timestamp(
    dt: *mut mgp_local_date_time,
    result: *mut i64,
) -> MgpError {
    if dt.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    *result = (*dt).micros;
    MgpError::NoError
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_now(
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if result.is_null() {
    ...
    *result = mgp_value::boxed(ValueInner::ZonedDateTime {
        micros,
        offset: 0,
        tz: CString::new("UTC").unwrap(),
    });
    MgpError::NoError
}

#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_timestamp(
    zdt: *mut mgp_zoned_date_time,
    result: *mut i64,
) -> MgpError {
    if zdt.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    *result = (*zdt).micros;
    MgpError::NoError
...
#[no_mangle]
pub unsafe extern "C" fn mgp_duration_from_microseconds(
    micros: i64,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_duration_get_microseconds(
    dur: *mut mgp_duration,
    result: *mut i64,
) -> MgpError {
    if result.is_null() || dur.is_null() {
        return MgpError::InvalidArgument;
    }
    *result = (*dur).micros;
    MgpError::NoError
...
#[no_mangle]
pub unsafe extern "C" fn mgp_unordered_map_make_empty(
    memory: *mut mgp_memory,
    result: *mut *mut mgp_map,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_date_add_duration(
    date: *mut mgp_date,
    dur: *mut mgp_duration,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if result.is_null() || date.is_null() || dur.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_date_sub_duration(
    date: *mut mgp_date,
    dur: *mut mgp_duration,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_add_duration(
    lt: *mut mgp_local_time,
    dur: *mut mgp_duration,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if result.is_null() || lt.is_null() || dur.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_sub_duration(
    lt: *mut mgp_local_time,
    dur: *mut mgp_duration,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_add_duration(
    dt: *mut mgp_local_date_time,
    dur: *mut mgp_duration,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if result.is_null() || dt.is_null() || dur.is_null() {
        return MgpError::InvalidArgument;
    }
    let new_micros = (*dt).micros
        + (*dur).micros
        + (*dur).days * 86_400_000_000i64
        + (*dur).months * 30 * 86_400_000_000i64;
    *result = mgp_value::boxed(ValueInner::LocalDateTime(new_micros));
    MgpError::NoError
}

#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_sub_duration(
    dt: *mut mgp_local_date_time,
    dur: *mut mgp_duration,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_add_duration(
    zdt: *mut mgp_zoned_date_time,
    dur: *mut mgp_duration,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if result.is_null() || zdt.is_null() || dur.is_null() {
        return MgpError::InvalidArgument;
    }
    let new_micros = (*zdt).micros
        + (*dur).micros
        + (*dur).days * 86_400_000_000i64
        + (*dur).months * 30 * 86_400_000_000i64;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_sub_duration(
    zdt: *mut mgp_zoned_date_time,
    dur: *mut mgp_duration,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_date_copy(
    src: *mut mgp_date,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_copy(
    src: *mut mgp_local_time,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if src.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_copy(
    src: *mut mgp_local_date_time,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if src.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_duration_copy(
    src: *mut mgp_duration,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if src.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_copy(
    src: *mut mgp_zoned_date_time,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
    if src.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_equal(
    a: *mut mgp_zoned_date_time,
    b: *mut mgp_zoned_date_time,
    result: *mut i32,
) -> MgpError {
    if result.is_null() || a.is_null() || b.is_null() {
        return MgpError::InvalidArgument;
    }
    *result = if (*a).micros == (*b).micros && (*a).offset == (*b).offset {
        1
    } else {
        0
    };
...
#[no_mangle]
pub unsafe extern "C" fn mgp_duration_add(
    a: *mut mgp_duration,
    b: *mut mgp_duration,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_duration_sub(
    a: *mut mgp_duration,
    b: *mut mgp_duration,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_duration_neg(
    dur: *mut mgp_duration,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_date_diff(
    a: *mut mgp_date,
    b: *mut mgp_date,
    result: *mut *mut mgp_duration,
) -> MgpError {
    ...
    *result = Box::into_raw(Box::new(mgp_duration {
        months: 0,
        days,
        micros: 0,
    }));
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_diff(
    a: *mut mgp_local_time,
    b: *mut mgp_local_time,
    result: *mut *mut mgp_duration,
) -> MgpError {
    if result.is_null() || a.is_null() || b.is_null() {
        return MgpError::InvalidArgument;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_diff(
    a: *mut mgp_local_date_time,
    b: *mut mgp_local_date_time,
    result: *mut *mut mgp_duration,
) -> MgpError {
    if result.is_null() || a.is_null() || b.is_null() {
        return MgpError::InvalidArgument;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_diff(
    a: *mut mgp_zoned_date_time,
    b: *mut mgp_zoned_date_time,
    result: *mut *mut mgp_duration,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_date_from_parameters(
    year: i64,
    month: i64,
    day: i64,
    memory: *mut mgp_memory,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_date_from_string(
    s: *const c_char,
    memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_from_parameters(
    hour: i64,
    minute: i64,
    second: i64,
    microsecond: i64,
    ...
    if let Some(t) = chrono::NaiveTime::from_hms_micro_opt(
        ...
        let us = t.hour() as i64 * 3_600_000_000
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_time_from_string(
    s: *const c_char,
    memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_from_parameters(
    year: i64,
    month: i64,
    day: i64,
    hour: i64,
    ...
    if let Some(d) = chrono::NaiveDate::from_ymd_opt(year as i32, month as u32, day as u32) {
        if let Some(t) = d.and_hms_micro_opt(
            hour as u32,
            minute as u32,
            second as u32,
            microsecond as u32,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_from_string(
    s: *const c_char,
    memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_from_parameters(
    year: i64,
    month: i64,
    day: i64,
    hour: i64,
    ...
    if let Some(d) = chrono::NaiveDate::from_ymd_opt(year as i32, month as u32, day as u32) {
        if let Some(t) = d.and_hms_micro_opt(
            ...
            let us = t.and_utc().timestamp_micros();
            let tz_name = if tz.is_null() {
                ""
            } else {
                unsafe { CStr::from_ptr(tz) }.to_str().unwrap_or("")
            };
            mgp_value_make_zoned_date_time(
                us,
                offset as i16,
                tz_name.as_ptr() as *const c_char,
                memory,
                result,
            )
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_from_string(
    s: *const c_char,
    memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_duration_from_parameters(
    months: i64,
    days: i64,
    microseconds: i64,
    memory: *mut mgp_memory,
...
fn parse_duration_str(s: &str) -> Option<(i64, i64, i64)> {
    ...
    for ch in s.chars() {
        match ch {
            ...
            'Y' => {
                months += num_str.parse::<i64>().ok()? * 12;
                num_str.clear();
            }
            'M' if in_time => {
            ...
            'M' => {
                months += num_str.parse::<i64>().ok()?;
                num_str.clear();
            }
            'D' => {
                days += num_str.parse::<i64>().ok()?;
                num_str.clear();
            }
            'H' => {
                microseconds += num_str.parse::<i64>().ok()? * 3_600_000_000;
                num_str.clear();
            }
            'S' => {
                if num_str.contains('.') {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_duration_from_string(
    s: *const c_char,
    memory: *mut mgp_memory,
    result: *mut *mut mgp_value,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_get_year(
    dt: *mut mgp_local_date_time,
    result: *mut i64,
) -> MgpError {
    if dt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_get_month(
    dt: *mut mgp_local_date_time,
    result: *mut i64,
) -> MgpError {
    if dt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_get_day(
    dt: *mut mgp_local_date_time,
    result: *mut i64,
) -> MgpError {
    if dt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_get_hour(
    dt: *mut mgp_local_date_time,
    result: *mut i64,
) -> MgpError {
    if dt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_get_minute(
    dt: *mut mgp_local_date_time,
    result: *mut i64,
) -> MgpError {
    if dt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_get_second(
    dt: *mut mgp_local_date_time,
    result: *mut i64,
) -> MgpError {
    if dt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_get_millisecond(
    dt: *mut mgp_local_date_time,
    result: *mut i64,
) -> MgpError {
    if dt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_local_date_time_get_microsecond(
    dt: *mut mgp_local_date_time,
    result: *mut i64,
) -> MgpError {
    if dt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_get_year(
    zdt: *mut mgp_zoned_date_time,
    result: *mut i64,
) -> MgpError {
    if zdt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_get_month(
    zdt: *mut mgp_zoned_date_time,
    result: *mut i64,
) -> MgpError {
    if zdt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_get_day(
    zdt: *mut mgp_zoned_date_time,
    result: *mut i64,
) -> MgpError {
    if zdt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_get_hour(
    zdt: *mut mgp_zoned_date_time,
    result: *mut i64,
) -> MgpError {
    if zdt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_get_minute(
    zdt: *mut mgp_zoned_date_time,
    result: *mut i64,
) -> MgpError {
    if zdt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_get_second(
    zdt: *mut mgp_zoned_date_time,
    result: *mut i64,
) -> MgpError {
    if zdt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_get_millisecond(
    zdt: *mut mgp_zoned_date_time,
    result: *mut i64,
) -> MgpError {
    if zdt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_get_microsecond(
    zdt: *mut mgp_zoned_date_time,
    result: *mut i64,
) -> MgpError {
    if zdt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_get_offset(
    zdt: *mut mgp_zoned_date_time,
    result: *mut i64,
) -> MgpError {
    if zdt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_zoned_date_time_get_timezone(
    zdt: *mut mgp_zoned_date_time,
    result: *mut *const c_char,
) -> MgpError {
    if zdt.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_point_2d_make(
    crs: u16,
    x: f64,
    y: f64,
    _memory: *mut mgp_memory,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_point_2d_copy(
    p: *mut mgp_point_2d,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_point_2d,
) -> MgpError {
    ...
    *result = Box::into_raw(Box::new(mgp_point_2d {
        crs: (*p).crs,
        x: (*p).x,
        y: (*p).y,
    }));
...
#[no_mangle]
pub unsafe extern "C" fn mgp_point_2d_equal(
    p1: *mut mgp_point_2d,
    p2: *mut mgp_point_2d,
    result: *mut i32,
) -> MgpError {
    ...
    *result = if (*p1).crs == (*p2).crs && (*p1).x == (*p2).x && (*p1).y == (*p2).y {
        1
    } else {
        0
    };
...
#[no_mangle]
pub unsafe extern "C" fn mgp_point_3d_make(
    crs: u16,
    x: f64,
    y: f64,
    z: f64,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_point_3d_copy(
    p: *mut mgp_point_3d,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_point_3d,
) -> MgpError {
    ...
    *result = Box::into_raw(Box::new(mgp_point_3d {
        crs: (*p).crs,
        x: (*p).x,
        y: (*p).y,
        z: (*p).z,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_point_3d_equal(
    p1: *mut mgp_point_3d,
    p2: *mut mgp_point_3d,
    result: *mut i32,
) -> MgpError {
    ...
    *result =
        if (*p1).crs == (*p2).crs && (*p1).x == (*p2).x && (*p1).y == (*p2).y && (*p1).z == (*p2).z
        {
            1
        } else {
            0
...
#[no_mangle]
pub unsafe extern "C" fn mgp_enum_make(
    enum_type: *const c_char,
    value: *const c_char,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_enum,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_enum_get_type_name(
    e: *mut mgp_enum,
    result: *mut *const c_char,
) -> MgpError {
    if e.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_enum_get_value_name(
    e: *mut mgp_enum,
    result: *mut *const c_char,
) -> MgpError {
    if e.is_null() || result.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_enum_copy(
    e: *mut mgp_enum,
    _memory: *mut mgp_memory,
    result: *mut *mut mgp_enum,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_enum_equal(
    e1: *mut mgp_enum,
    e2: *mut mgp_enum,
    result: *mut i32,
) -> MgpError {
    ...
    *result = if (*e1).ty == (*e2).ty && (*e1).val == (*e2).val {
        1
    } else {
        0
    };
...
#[no_mangle]
pub unsafe extern "C" fn mgp_result_set_error_msg(
    result: *mut mgp_result,
    msg: *const c_char,
) -> MgpError {
    if result.is_null() || msg.is_null() {
        return MgpError::InvalidArgument;
    }
    let res = &mut *result;
...
#[no_mangle]
pub unsafe extern "C" fn mgp_result_new_record(
    result: *mut mgp_result,
    out: *mut *mut mgp_result_record,
) -> MgpError {
    if result.is_null() || out.is_null() {
        return MgpError::InvalidArgument;
    }
    let record = Box::into_raw(Box::new(mgp_result_record {
        fields: HashMap::new(),
    }));
...
#[no_mangle]
pub unsafe extern "C" fn mgp_result_record_insert(
    record: *mut mgp_result_record,
    name: *const c_char,
    val: *mut mgp_value,
) -> MgpError {
    if record.is_null() || name.is_null() || val.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_func_result_set_error_msg(
    result: *mut mgp_func_result,
    msg: *const c_char,
    _memory: *mut mgp_memory,
) -> MgpError {
    if result.is_null() || msg.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_func_result_set_value(
    result: *mut mgp_func_result,
    val: *mut mgp_value,
    _memory: *mut mgp_memory,
) -> MgpError {
    if result.is_null() || val.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_module_add_read_procedure(
    module: *mut mgp_module,
    name: *const c_char,
    cb: MgpProcCb,
    result: *mut *mut mgp_proc,
) -> MgpError {
    if module.is_null() || name.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_module_add_write_procedure(
    module: *mut mgp_module,
    name: *const c_char,
    cb: MgpProcCb,
    result: *mut *mut mgp_proc,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_module_add_transformation(
    module: *mut mgp_module,
    name: *const c_char,
    cb: MgpProcCb,
    result: *mut *mut mgp_proc,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_module_add_batch_read_procedure(
    module: *mut mgp_module,
    name: *const c_char,
    cb: MgpProcCb,
    _initializer: MgpProcCb,
    _cleanup: MgpProcCb,
    result: *mut *mut mgp_proc,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_module_add_batch_write_procedure(
    module: *mut mgp_module,
    name: *const c_char,
    cb: MgpProcCb,
    _initializer: MgpProcCb,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_module_add_function(
    module: *mut mgp_module,
    name: *const c_char,
    cb: MgpFuncCb,
    result: *mut *mut mgp_func,
) -> MgpError {
    if module.is_null() || name.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mgp_proc_add_arg(
    proc_: *mut mgp_proc,
    name: *const c_char,
    ty: *mut mgp_type,
) -> MgpError {
    if proc_.is_null() || name.is_null() || ty.is_null() {
        return MgpError::InvalidArgument;
    }
    let cname = CString::new(CStr::from_ptr(name).to_bytes()).unwrap_or_default();
    (*proc_).args.push(ArgDesc {
        name: cname,
        ty,
        default_value: None,
    });
...
#[no_mangle]
pub unsafe extern "C" fn mgp_proc_add_opt_arg(
    proc_: *mut mgp_proc,
    name: *const c_char,
    ty: *mut mgp_type,
    def: *mut mgp_value,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_proc_add_result(
    proc_: *mut mgp_proc,
    name: *const c_char,
    ty: *mut mgp_type,
) -> MgpError {
    ...
    let cname = CString::new(CStr::from_ptr(name).to_bytes()).unwrap_or_default();
    (*proc_).results.push(ResultField {
        name: cname,
        ty,
        deprecated: false,
    });
...
#[no_mangle]
pub unsafe extern "C" fn mgp_proc_add_deprecated_result(
    proc_: *mut mgp_proc,
    name: *const c_char,
    ty: *mut mgp_type,
) -> MgpError {
...
#[no_mangle]
pub unsafe extern "C" fn mgp_func_add_arg(
    func: *mut mgp_func,
    name: *const c_char,
    ty: *mut mgp_type,
) -> MgpError {
    if func.is_null() || name.is_null() || ty.is_null() {
        return MgpError::InvalidArgument;
    }
    let cname = CString::new(CStr::from_ptr(name).to_bytes()).unwrap_or_default();
    (*func).args.push(ArgDesc {
        name: cname,
        ty,
        default_value: None,
    });
...
#[no_mangle]
pub unsafe extern "C" fn mgp_func_add_opt_arg(
    func: *mut mgp_func,
    name: *const c_char,
    ty: *mut mgp_type,
    def: *mut mgp_value,
...
#[no_mangle]
pub unsafe extern "C" fn mgp_type_list(
    elem: *mut mgp_type,
    result: *mut *mut mgp_type,
) -> MgpError {
    if elem.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    *result = Box::into_raw(Box::new(mgp_type {
        tag: MgpTypeTag::List,
        elem,
    }));
    MgpError::NoError
...
#[no_mangle]
pub unsafe extern "C" fn mgp_type_nullable(
    ty: *mut mgp_type,
    result: *mut *mut mgp_type,
) -> MgpError {
    if ty.is_null() || result.is_null() {
        return MgpError::InvalidArgument;
    }
    *result = Box::into_raw(Box::new(mgp_type {
        tag: MgpTypeTag::Nullable,
        elem: ty,
    }));
    MgpError::NoError
}
...
pub unsafe extern "C" fn mgp_create_existence_constraint(
    ...
    if storage
        .constraints
        .has_existence_constraint(label_id, prop_id)
    {
        *result = 0;
    } else {
        storage
...
pub unsafe extern "C" fn mgp_create_unique_constraint(
    ...
    if storage
        .constraints
        .has_unique_constraint(label_id, &prop_ids)
    {
        *result = 0;
    } else {
        storage
            .constraints
            .add_unique_constraint(label_id, prop_ids);
        *result = 1;
    }
    MgpError::NoError
}
...
pub unsafe extern "C" fn mgp_drop_unique_constraint(
        ...
        .has_unique_constraint(label_id, &prop_ids)
    {
        storage
            .constraints
            .remove_unique_constraint(label_id, &prop_ids);
        *result = 1;
    } else {
        *result = 0;
    }
...
pub unsafe extern "C" fn mgp_create_text_index(
    ...
    match mgstorage::text_index::TextIndex::create(&path, &prop_names) {
        Ok(index) => {
            ...
            let entry = mgstorage::storage::TextIndexEntry::new(
...
#[no_mangle]
pub unsafe extern "C" fn mgp_drop_text_index(g: *mut mgp_graph, label: *const c_char) -> MgpError {
    if g.is_null() || label.is_null() {
        return MgpError::InvalidArgument;
    }
    let storage = &*(*g).storage;
...
pub unsafe extern "C" fn mgp_create_vector_index(
    ...
    let entry =
        mgstorage::storage::VectorIndexEntry::new(index.clone(), property_id, dimension, distance);
...
pub unsafe extern "C" fn mgp_graph_search_vector_index(
    ...
    for item in &(*query).items {
        match &(**item).inner {
            ...
            _ => {
                return build_search_error_result(
                    result,
                    "Vector search query must contain only numeric values",
                );
            }
        }
    }
    ...
    for (node_id, distance) in search_results {
        ...
        let vertex = Box::into_raw(Box::new(mgp_vertex {
            gid: gid.as_uint(),
            graph: g,
        }));
        ...
        let triple = Box::into_raw(Box::new(mgp_list {
            items: vec![vertex_val, dist_val, sim_val],
        }));
...
pub unsafe extern "C" fn mgp_graph_search_vector_index_on_edges(
    ...
    let storage = &*(*g).storage;
    let catalog = graph_catalog(g);
    let edge_type_name = CStr::from_ptr(index_name).to_string_lossy();
    let edge_type_id = catalog.edge_type(&edge_type_name);
    ...
    // Linear scan over all edges — no dedicated edge vector index yet.
    let edges = storage.all_edges();
    let mut scored: Vec<(Gid, f32)> = Vec::new();
    for (gid, _from, _to, etype, props) in edges {
        if etype != edge_type_id {
            continue;
        }
        for (_prop_id, value) in props.iter() {
            if let PropertyValue::List(list) = value {
                let vec: Vec<f32> = list
                    .iter()
                    .filter_map(|v| match v {
                        PropertyValue::Double(d) => Some(*d as f32),
                        PropertyValue::Int(i) => Some(*i as f32),
                        _ => None,
                    })
                    .collect();
                if vec.len() == query_vec.len() && !vec.is_empty() {
                    let dist = mgvector::Distance::Euclidean.compute(&vec, &query_vec);
                    scored.push((gid, dist));
                    break;
                }
            }
        }
    ...
    for (gid, distance) in scored {
        let edge = Box::into_raw(Box::new(mgp_edge {
            gid: gid.as_uint(),
            graph: g,
        }));
        let edge_val = mgp_value::boxed(ValueInner::Edge(edge));
        let dist_val = mgp_value::boxed(ValueInner::Double(distance as f64));
        let sim_val = mgp_value::boxed(ValueInner::Double(1.0 / (1.0 + distance as f64)));

        let triple = Box::into_raw(Box::new(mgp_list {
            items: vec![edge_val, dist_val, sim_val],
        }));
        let triple_val = mgp_value::boxed(ValueInner::List(triple));
        (*results_list).items.push(triple_val);
    }
...
pub unsafe extern "C" fn mgp_graph_search_text_index(
    ...
    for (gid, score) in search_results {
        ...
        let pair = Box::into_raw(Box::new(mgp_list {
            items: vec![vertex_val, score_val],
        }));
...
pub unsafe extern "C" fn mgp_graph_search_text_edge_index(
    ...
    let edge_type_name = CStr::from_ptr(index_name).to_string_lossy();
    let edge_type_id = catalog.edge_type(&edge_type_name);
    let query_str = CStr::from_ptr(search_query).to_string_lossy().to_lowercase();

    // Linear scan over all edges — no dedicated edge text index yet.
    let edges = storage.all_edges();
    let mut matches: Vec<(Gid, f64)> = Vec::new();
    for (gid, _from, _to, etype, props) in edges {
        if etype != edge_type_id {
            continue;
        }
        for (_prop_id, value) in props.iter() {
            if let PropertyValue::String(s) = value {
                if s.to_lowercase().contains(&query_str) {
                    matches.push((gid, 1.0));
                    break;
                }
            }
        }
    ...
    for (gid, score) in matches {
        ...
        let edge_val = mgp_value::boxed(ValueInner::Edge(edge));
        let score_val = mgp_value::boxed(ValueInner::Double(score));

        let pair = Box::into_raw(Box::new(mgp_list {
            items: vec![edge_val, score_val],
        }));
        let pair_val = mgp_value::boxed(ValueInner::List(pair));
        (*results_list).items.push(pair_val);
    }
...
pub unsafe extern "C" fn mgp_graph_aggregate_over_text_index(
    ...
    let text_indices = storage.text_indices.read().unwrap();
    let count = match text_indices.get(&label_id) {
        Some(entry) => entry.index.search(&query_str, 10_000).map(|r| r.len()).unwrap_or(0),
        None => 0,
    };
    drop(text_indices);
    ...
    let count_val = mgp_value::boxed(ValueInner::Int(count as i64));
    let key = CString::new("count").unwrap();
    result_map.items.insert(key, count_val);
...
pub unsafe extern "C" fn mgp_graph_aggregate_over_text_edge_index(
    ...
    for (_gid, _from, _to, etype, props) in edges {
        if etype != edge_type_id {
            continue;
        }
        for (_prop_id, value) in props.iter() {
...
pub unsafe extern "C" fn mgp_list_all_label_property_indices(
    ...
    for &(label_id, prop_id) in active.iter() {
        ...
        let label_val = mgp_value::boxed(ValueInner::String(
            CString::new(label_name).unwrap_or_default(),
        ));
        let prop_val = mgp_value::boxed(ValueInner::String(
            CString::new(prop_name).unwrap_or_default(),
        ));
        map.items.insert(CString::new("label").unwrap(), label_val);
        map.items
            .insert(CString::new("property").unwrap(), prop_val);
...
pub unsafe extern "C" fn mgp_list_all_unique_constraints(
    ...
    for c in storage.constraints.list() {
        if !matches!(c.kind, mgstorage::constraints::ConstraintKind::Unique) {
            continue;
        }
        let mut map = mgp_map {
            items: HashMap::new(),
        ...
        map.items.insert(
            ...
            mgp_value::boxed(ValueInner::String(
                CString::new(label_name).unwrap_or_default(),
            )),
        );
        map.items.insert(
            CString::new("property").unwrap(),
            mgp_value::boxed(ValueInner::String(
                CString::new(prop_name).unwrap_or_default(),
            )),
        );
...
pub unsafe extern "C" fn mgp_list_all_existence_constraints(
    ...
    let mut list = mgp_list { items: Vec::new() };
    for c in storage.constraints.list() {
        if !matches!(c.kind, mgstorage::constraints::ConstraintKind::Existence) {
            continue;
        }
        let mut map = mgp_map {
            items: HashMap::new(),
...
pub unsafe extern "C" fn mgp_graph_show_index_info(
    ...
    drop(active_label);
    result_map.items.insert(
        CString::new("label_indices").unwrap(),
        mgp_value::boxed(ValueInner::List(label_idx_list)),
    );
    ...
    for &(label_id, prop_id) in active_lp.iter() {
        ...
        map.items.insert(
            CString::new("label").unwrap(),
            mgp_value::boxed(ValueInner::String(
                CString::new(catalog.label_name(label_id)).unwrap_or_default(),
            )),
        );
        map.items.insert(
            CString::new("property").unwrap(),
            mgp_value::boxed(ValueInner::String(
                CString::new(catalog.property_name(prop_id)).unwrap_or_default(),
            )),
        );
        let map_ptr = Box::into_raw(Box::new(map));
        (*lp_idx_list)
            .items
            .push(mgp_value::boxed(ValueInner::Map(map_ptr)));
    }
    drop(active_lp);
    result_map.items.insert(
        CString::new("label_property_indices").unwrap(),
        mgp_value::boxed(ValueInner::List(lp_idx_list)),
    );
...
pub unsafe extern "C" fn mgp_execute_query(
    ...
    match mginterp::execute_with_catalog(storage, query_str, Some(catalog)) {
        Ok(query_result) => {
            let columns: Vec<CString> = query_result
                .columns
                .iter()
...
#[no_mangle]
pub unsafe extern "C" fn mgp_track_current_thread_allocations(
    _memory: *mut mgp_memory,
) -> MgpError {
    MgpError::NoError
}
...
#[no_mangle]
pub unsafe extern "C" fn mgp_untrack_current_thread_allocations(
    _memory: *mut mgp_memory,
) -> MgpError {
    MgpError::NoError
}
...
#[no_mangle]
pub unsafe extern "C" fn mgp_init_module(
    _module: *mut mgp_module,
    _memory: *mut mgp_memory,
) -> MgpError {
    MgpError::NoError
}
...
mod tests {
    ...
    fn value_make_and_get_int() {
        unsafe {
            ...
            assert_eq!(
                mgp_value_make_int(42, ptr::null_mut(), &mut v),
                MgpError::NoError
            );
            assert!(!v.is_null());
            let mut got = 0i64;
    ...
    fn value_string_roundtrip() {
        unsafe {
            ...
            let mut v: *mut mgp_value = ptr::null_mut();
            assert_eq!(
                mgp_value_make_string(s.as_ptr(), ptr::null_mut(), &mut v),
                MgpError::NoError
            );
    ...
    fn list_append_and_iterate() {
        unsafe {
            ...
            assert_eq!(
                mgp_list_make_empty(4, ptr::null_mut(), &mut list),
                MgpError::NoError
            );
            for i in 0..3 {
                let mut v: *mut mgp_value = ptr::null_mut();
    ...
    fn null_arg_returns_invalid_argument() {
        unsafe {
            assert_eq!(
                mgp_value_get_int(ptr::null(), ptr::null_mut()),
                MgpError::InvalidArgument
            );
            let mut v: *mut mgp_value = ptr::null_mut();
            mgp_value_make_int(1, ptr::null_mut(), &mut v);
            assert_eq!(
                mgp_value_get_int(v, ptr::null_mut()),
                MgpError::InvalidArgument
            );
            mgp_value_destroy(v);
        }
    ...
    fn path_make_expand_pop() {
        unsafe {
            let v: *mut mgp_vertex = Box::into_raw(Box::new(mgp_vertex {
                gid: 1,
                graph: ptr::null(),
            }));
            let mut path: *mut mgp_path = ptr::null_mut();
            assert_eq!(
                mgp_path_make_with_start(v, ptr::null_mut(), &mut path),
                MgpError::NoError
            );
            assert!(!path.is_null());
            ...
            let e: *mut mgp_edge = Box::into_raw(Box::new(mgp_edge {
                gid: 10,
                graph: ptr::null(),
            }));
    ...
    fn path_copy_and_equal() {
        unsafe {
            ...
            assert_eq!(
                mgp_path_copy(path1, ptr::null_mut(), &mut path2),
                MgpError::NoError
            );
    ...
    fn mutation_roundtrip() {
        ...
        unsafe {
            ...
            assert_eq!(
                mgp_graph_create_vertex(&graph as *const _ as *mut _, ptr::null_mut(), &mut v),
                MgpError::NoError
            );
            assert!(!v.is_null());
            ...
            assert_eq!(
                mgp_vertex_set_property(v, key.as_ptr(), val),
                MgpError::NoError
            );
            ...
            assert_eq!(
                mgp_graph_create_vertex(&graph as *const _ as *mut _, ptr::null_mut(), &mut v2),
                MgpError::NoError
            );
            ...
            // Delete the edge
            assert_eq!(
                mgp_graph_delete_edge(&graph as *const _ as *mut _, e),
                MgpError::NoError
            );
            mgp_edge_destroy(e);
            ...
            // Delete vertices
            assert_eq!(
                mgp_graph_delete_vertex(&graph as *const _ as *mut _, v2),
                MgpError::NoError
            );
            assert_eq!(
                mgp_graph_delete_vertex(&graph as *const _ as *mut _, v),
                MgpError::NoError
            );
    ...
    fn vertex_label_and_edge_type_roundtrip() {
        ...
        unsafe {
            ...
            let mut has2: i32 = 0;
            assert_eq!(
                mgp_vertex_has_label_named(v, label.as_ptr(), &mut has2),
                MgpError::NoError
            );
            assert_eq!(has2, 1);
            ...
            assert_eq!(
                mgp_vertex_iter_properties(v, ptr::null_mut(), &mut pit),
                MgpError::NoError
            );
            assert!(!pit.is_null());
            ...
            assert_eq!(
                mgp_properties_iterator_get(pit, &mut prop),
                MgpError::NoError
            );
            assert!(!prop.is_null());
    ...
    fn module_procedure_registration_roundtrip() {
        ...
        unsafe extern "C" fn dummy_func(
            _args: *mut mgp_list,
            _graph: *mut mgp_graph,
            _result: *mut mgp_func_result,
            _memory: *mut mgp_memory,
        ) {
        }

        unsafe {
            let mut module = mgp_module {
                procs: Vec::new(),
                funcs: Vec::new(),
            };
            ...
            assert_eq!(
                mgp_module_add_read_procedure(&mut module, name.as_ptr(), dummy_proc, &mut proc),
                MgpError::NoError
            );
            assert!(!proc.is_null());
            ...
            assert_eq!(
                mgp_proc_add_arg(proc, arg_name.as_ptr(), ty),
                MgpError::NoError
            );
            let res_name = CString::new("output").unwrap();
            assert_eq!(
                mgp_proc_add_result(proc, res_name.as_ptr(), ty),
                MgpError::NoError
            );
            ...
            assert_eq!(
                mgp_module_add_write_procedure(&mut module, wname.as_ptr(), dummy_proc, &mut wproc),
                MgpError::NoError
            );
            ...
            assert_eq!(
                mgp_module_add_function(&mut module, fname.as_ptr(), dummy_func, &mut func),
                MgpError::NoError
            );
            assert!(!func.is_null());

            // Result API
            let mut result = mgp_result {
                error: None,
                records: Vec::new(),
                reserved: 0,
            };
            ...
            assert_eq!(
                mgp_result_new_record(&mut result, &mut record),
                MgpError::NoError
            );
            ...
            assert_eq!(
                mgp_result_record_insert(record, field.as_ptr(), val),
                MgpError::NoError
            );

            // Func result API
            let mut fresult = mgp_func_result {
                error: None,
                value: None,
            };
            ...
            assert_eq!(
                mgp_func_result_set_value(&mut fresult, fval, ptr::null_mut()),
                MgpError::NoError
            );
            assert!(fresult.value.is_some());

            // Error on result
            let mut eresult = mgp_result {
                error: None,
                records: Vec::new(),
                reserved: 0,
            };
            ...
            assert_eq!(
                mgp_result_set_error_msg(&mut eresult, errmsg.as_ptr()),
                MgpError::NoError
            );
    ...
    fn index_and_constraint_apis() {
        ...
        unsafe {
            ...
            let tx = Box::into_raw(Box::new(
                (*storage)
                    .transaction_engine
                    .begin(mgcore::delta::IsolationLevel::SnapshotIsolation),
            ));
            let mut graph = mgp_graph {
                storage,
                tx,
                catalog,
            };
            ...
            assert_eq!(
                mgp_create_label_index(&mut graph, label.as_ptr(), &mut result),
                MgpError::NoError
            );
            ...
            assert_eq!(
                mgp_drop_label_index(&mut graph, label.as_ptr(), &mut result),
                MgpError::NoError
            );
            ...
            assert_eq!(
                mgp_create_existence_constraint(
                    &mut graph,
                    label.as_ptr(),
                    prop.as_ptr(),
                    &mut result
            ...
            list.items.push(v);
            assert_eq!(
                mgp_create_unique_constraint(&mut graph, label.as_ptr(), &list, &mut result),
                MgpError::NoError
            );
            assert_eq!(result, 1);
            assert_eq!(
            ...
            assert_eq!(result, 0); // already exists
            assert_eq!(
                mgp_drop_unique_constraint(&mut graph, label.as_ptr(), &list, &mut result),
                MgpError::NoError
            );
            assert_eq!(result, 1);
            assert_eq!(
    ...
    fn vertex_get_property_roundtrip() {
        ...
        unsafe {
            ...
            let mut got: *mut mgp_value = ptr::null_mut();
            assert_eq!(
                mgp_vertex_get_property(v, key.as_ptr(), ptr::null_mut(), &mut got),
                MgpError::NoError
            );
            assert!(!got.is_null());
            let mut n = 0i64;
    ...
    fn edge_get_property_and_endpoints() {
        ...
        unsafe {
            ...
            let etype = mgp_edge_type {
                name: etype_name.as_ptr(),
            };
            let mut e: *mut mgp_edge = ptr::null_mut();
            ...
            let mut got: *mut mgp_value = ptr::null_mut();
            assert_eq!(
                mgp_edge_get_property(e, key.as_ptr(), ptr::null_mut(), &mut got),
                MgpError::NoError
            );
            let mut n = 0i64;
            mgp_value_get_int(got, &mut n);
    ...
    fn path_vertex_and_edge_at() {
        unsafe {
            let v1 = Box::into_raw(Box::new(mgp_vertex {
                gid: 1,
                graph: ptr::null(),
            }));
            let e = Box::into_raw(Box::new(mgp_edge {
            ...
            assert_eq!(
                mgp_path_vertex_at(path, 99, &mut got_v),
                MgpError::OutOfRange
            );
    ...
    fn list_copy_preserves_items() {
        unsafe {
            ...
            assert_eq!(
                mgp_list_copy(list, ptr::null_mut(), &mut copy),
                MgpError::NoError
            );
    ...
    fn map_copy_preserves_entries() {
        unsafe {
            ...
            assert_eq!(
                mgp_map_copy(map, ptr::null_mut(), &mut copy),
                MgpError::NoError
            );
    ...
    fn vertices_iterator_next_and_mutability() {
        ...
        unsafe {
            ...
            assert_eq!(
                mgp_vertices_iterator_underlying_graph_is_mutable(it, &mut mutable),
                MgpError::NoError
            );
            assert_eq!(mutable, 1);
    ...
    fn value_type_predicates_for_all_types() {
        unsafe {
            ...
            let mut flag = 0i32;
            mgp_value_is_null(v, &mut flag);
            assert_eq!(flag, 1);
            mgp_value_is_int(v, &mut flag);
            assert_eq!(flag, 0);
            mgp_value_destroy(v);
            ...
            mgp_value_make_zoned_date_time(
                10,
                0,
                CString::new("UTC").unwrap().as_ptr(),
                ptr::null_mut(),
                &mut v,
            );
            mgp_value_is_zoned_date_time(v, &mut flag);
            assert_eq!(flag, 1);
            mgp_value_destroy(v);

            mgp_value_make_point_2d(7203, 1.0, 2.0, ptr::null_mut(), &mut v);
            mgp_value_is_point_2d(v, &mut flag);
            assert_eq!(flag, 1);
            mgp_value_destroy(v);

            mgp_value_make_point_3d(9157, 1.0, 2.0, 3.0, ptr::null_mut(), &mut v);
            mgp_value_is_point_3d(v, &mut flag);
            assert_eq!(flag, 1);
            mgp_value_destroy(v);
    ...
    fn transformation_ctx_graph_and_add_record() {
        use crate::stream::*;
        unsafe {
            let mut ctx: *mut mgp_transformation_ctx =
                Box::into_raw(Box::new(mgp_transformation_ctx {
                    graph: ptr::null_mut(),
                    records: Vec::new(),
                }));
            ...
            assert_eq!(
                mgp_transformation_ctx_add_record(ctx, record),
                MgpError::NoError
            );
    ...
    fn trigger_context_event_type_and_iterators() {
        ...
        unsafe {
            ...
            assert_eq!(
                mgp_trigger_context_event_type(ctx, &mut event),
                MgpError::NoError
            );
            ...
            let mut it: *mut mgp_vertices_iterator = ptr::null_mut();
            assert_eq!(
                mgp_trigger_context_created_vertices(ctx, &mut it),
                MgpError::NoError
            );
            assert!(!it.is_null());
            ...
            assert_eq!(
                mgp_trigger_context_created_edges(ctx, &mut eit),
                MgpError::NoError
            );
    ...
    fn trigger_context_set_and_removed_property_vertices() {
        ...
        unsafe {
            ...
            assert_eq!(
                mgp_trigger_context_set_property_vertices(ctx, &mut it),
                MgpError::NoError
            );
            let mut v: *mut mgp_vertex = ptr::null_mut();
            ...
            assert_eq!(
                mgp_set_property_vertices_iterator_get(it, &mut v, &mut pname, &mut ov, &mut nv),
                MgpError::NoError
            );
            assert!(!v.is_null());
            assert_eq!((*v).gid, 5);
            ...
            assert_eq!(
                mgp_trigger_context_removed_property_vertices(ctx, &mut rit),
                MgpError::NoError
            );
            ...
            assert_eq!(
                mgp_removed_property_vertices_iterator_get(rit, &mut rv, &mut rpname, &mut rov),
                MgpError::NoError
            );
            assert!(!rv.is_null());
            assert_eq!((*rv).gid, 6);
    ...
    fn trigger_context_vertex_before_after() {
        use crate::stream::*;
        unsafe {
            let vb = Box::into_raw(Box::new(mgp_vertex {
                gid: 7,
                graph: ptr::null(),
            }));
            let va = Box::into_raw(Box::new(mgp_vertex {
                gid: 8,
                graph: ptr::null(),
            }));
            let eb = Box::into_raw(Box::new(mgp_edge {
                gid: 70,
                graph: ptr::null(),
            }));
            let ea = Box::into_raw(Box::new(mgp_edge {
                gid: 80,
                graph: ptr::null(),
            }));
            let ctx = Box::into_raw(Box::new(mgp_trigger_context {
            ...
            assert_eq!(
                mgp_trigger_context_vertex_before(ctx, &mut got_vb),
                MgpError::NoError
            );
            assert_eq!(
                mgp_trigger_context_vertex_after(ctx, &mut got_va),
                MgpError::NoError
            );
            assert_eq!(
                mgp_trigger_context_edge_before(ctx, &mut got_eb),
                MgpError::NoError
            );
            assert_eq!(
                mgp_trigger_context_edge_after(ctx, &mut got_ea),
                MgpError::NoError
            );
    ...
    fn search_text_index_finds_indexed_vertex() {
        ...
        unsafe {
            ...
            (*storage)
                .create_vertex(&*tx, mgcore::types::Gid::from(1u64))
                .unwrap();
            (*storage)
                .vertex_add_label(&*tx, mgcore::types::Gid::from(1u64), label_id)
                .unwrap();
            (*storage)
                .vertex_set_property(
                    &*tx,
                    mgcore::types::Gid::from(1u64),
                    prop_id,
                    mgcore::property_value::PropertyValue::String("Hello World".into()),
                )
                .unwrap();
    ...
    fn search_vector_index_empty_when_no_index() {
        ...
        unsafe {
            ...
            let mut result: *mut mgp_list = ptr::null_mut();
            assert_eq!(
                mgp_search_vector_index(
                    &graph as *const _ as *mut _,
                    CString::new("Person").unwrap().as_ptr(),
                    query,
                    5,
                    &mut result
                ),
    ...
    fn date_get_fields_correct() {
        unsafe {
            ...
            assert_eq!(
                mgp_date_get_year(&date as *const _ as *mut _, &mut year),
                MgpError::NoError
            );
            assert_eq!(
                mgp_date_get_month(&date as *const _ as *mut _, &mut month),
                MgpError::NoError
            );
            assert_eq!(
                mgp_date_get_day(&date as *const _ as *mut _, &mut day),
                MgpError::NoError
            );
            assert_eq!(
                mgp_date_timestamp(&date as *const _ as *mut _, &mut ts),
                MgpError::NoError
            );
    ...
    fn local_time_get_fields_correct() {
        unsafe {
            ...
            assert_eq!(
                mgp_local_time_get_hour(&time as *const _ as *mut _, &mut hour),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_time_get_minute(&time as *const _ as *mut _, &mut minute),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_time_get_second(&time as *const _ as *mut _, &mut second),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_time_get_millisecond(&time as *const _ as *mut _, &mut millisecond),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_time_get_microsecond(&time as *const _ as *mut _, &mut microsecond),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_time_timestamp(&time as *const _ as *mut _, &mut ts),
                MgpError::NoError
            );
    ...
    fn local_date_time_get_fields_correct() {
        unsafe {
            ...
            assert_eq!(
                mgp_local_date_time_get_year(&dt as *const _ as *mut _, &mut year),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_date_time_get_month(&dt as *const _ as *mut _, &mut month),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_date_time_get_day(&dt as *const _ as *mut _, &mut day),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_date_time_get_hour(&dt as *const _ as *mut _, &mut hour),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_date_time_get_minute(&dt as *const _ as *mut _, &mut minute),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_date_time_get_second(&dt as *const _ as *mut _, &mut second),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_date_time_get_millisecond(&dt as *const _ as *mut _, &mut millisecond),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_date_time_get_microsecond(&dt as *const _ as *mut _, &mut microsecond),
                MgpError::NoError
            );
            assert_eq!(
                mgp_local_date_time_timestamp(&dt as *const _ as *mut _, &mut ts),
                MgpError::NoError
            );
    ...
    fn zoned_date_time_get_fields_correct() {
        unsafe {
            ...
            assert_eq!(
                mgp_zoned_date_time_get_year(&zdt as *const _ as *mut _, &mut year),
                MgpError::NoError
            );
            assert_eq!(
                mgp_zoned_date_time_get_month(&zdt as *const _ as *mut _, &mut month),
                MgpError::NoError
            );
            assert_eq!(
                mgp_zoned_date_time_get_day(&zdt as *const _ as *mut _, &mut day),
                MgpError::NoError
            );
            assert_eq!(
                mgp_zoned_date_time_get_hour(&zdt as *const _ as *mut _, &mut hour),
                MgpError::NoError
            );
            assert_eq!(
                mgp_zoned_date_time_get_offset(&zdt as *const _ as *mut _, &mut offset),
                MgpError::NoError
            );
            assert_eq!(
                mgp_zoned_date_time_get_timezone(&zdt as *const _ as *mut _, &mut tz_ptr),
                MgpError::NoError
            );
    ...
    fn search_vector_index_hits_when_index_exists() {
        ...
        unsafe {
            ...
            mgp_value_make_string(
                CString::new("embedding").unwrap().as_ptr(),
                ptr::null_mut(),
                &mut prop_val,
            );
            ...
            assert_eq!(
                mgp_create_vector_index(
                    &mut graph,
                    label.as_ptr(),
                    prop_list,
                    2,
                    CString::new("cosine").unwrap().as_ptr()
                ),
                MgpError::NoError
            );
            mgp_list_destroy(prop_list);
            ...
            // Insert vectors into the HNSW index manually via VectorIndexEntry
            {
                let indices = (*storage).vector_indices.read().unwrap();
                let entry = indices
                    .get(&mgcatalog::Catalog::new().label("Item"))
                    .unwrap();
            ...
            let mut result: *mut mgp_list = ptr::null_mut();
            assert_eq!(
                mgp_search_vector_index(&mut graph, label.as_ptr(), query, 2, &mut result),
                MgpError::NoError
            );
            assert!(!result.is_null());
            let mut size = 0usize;
    ...
    #[test]
    fn search_vector_index_on_edges_finds_edges() {
        use mgstorage::storage::Storage;
        unsafe {
            let storage = Box::into_raw(Box::new(Storage::new()));
            let catalog = Box::into_raw(Box::new(mgcatalog::Catalog::new()));
            ...
            let edge_type_id = (*catalog).edge_type("KNOWS");
            let prop_id = (*catalog).property("embedding");

            // Create vertices and an edge with a vector property
            let v1 = mgcore::types::Gid::from(1u64);
            let v2 = mgcore::types::Gid::from(2u64);
            let e1 = mgcore::types::Gid::from(10u64);
            (*storage).create_vertex(&*tx, v1).unwrap();
            (*storage).create_vertex(&*tx, v2).unwrap();
            (*storage)
                .create_edge(&*tx, e1, v1, v2, edge_type_id)
                .unwrap();
            (*storage)
                .edge_set_property(
                    &*tx,
                    e1,
                    prop_id,
                    mgcore::property_value::PropertyValue::List(vec![
                        mgcore::property_value::PropertyValue::Double(1.0),
                        mgcore::property_value::PropertyValue::Double(0.0),
                    ]),
                )
                .unwrap();
            ...
            let mut result: *mut mgp_map = ptr::null_mut();
            assert_eq!(
                mgp_graph_search_vector_index_on_edges(
                    &graph as *const _ as *mut _,
                    CString::new("KNOWS").unwrap().as_ptr(),
                    query,
                    5,
                    ptr::null_mut(),
                    &mut result
            ...
            // Check search_results key exists
            let mut results_val: *mut mgp_value = ptr::null_mut();
            mgp_map_at(result, CString::new("search_results").unwrap().as_ptr(), &mut results_val);
            assert!(!results_val.is_null());
            let mut results_list: *const mgp_list = ptr::null();
            mgp_value_get_list(results_val, &mut results_list);
            let mut size = 0usize;
            mgp_list_size(results_list, &mut size);
            assert_eq!(size, 1); // 1 edge matched

            mgp_list_destroy(query);
            mgp_map_destroy(result);
            drop(Box::from_raw(tx));
            drop(Box::from_raw(catalog));
            drop(Box::from_raw(storage));
        }
    ...
    #[test]
    fn search_text_edge_index_finds_edges() {
        use mgstorage::storage::Storage;
        unsafe {
            let storage = Box::into_raw(Box::new(Storage::new()));
            let catalog = Box::into_raw(Box::new(mgcatalog::Catalog::new()));
            ...
            let edge_type_id = (*catalog).edge_type("LIKES");
            let prop_id = (*catalog).property("note");

            let v1 = mgcore::types::Gid::from(1u64);
            let v2 = mgcore::types::Gid::from(2u64);
            let e1 = mgcore::types::Gid::from(20u64);
            (*storage).create_vertex(&*tx, v1).unwrap();
            (*storage).create_vertex(&*tx, v2).unwrap();
            (*storage)
                .create_edge(&*tx, e1, v1, v2, edge_type_id)
            ...
            (*storage)
                .edge_set_property(
                    ...
                    e1,
                    prop_id,
                    mgcore::property_value::PropertyValue::String("Hello edge".into()),
                )
                .unwrap();

            let mut result: *mut mgp_map = ptr::null_mut();
            assert_eq!(
                mgp_graph_search_text_edge_index(
                    &graph as *const _ as *mut _,
                    CString::new("LIKES").unwrap().as_ptr(),
                    CString::new("hello").unwrap().as_ptr(),
                    0,
                    10,
                    ptr::null_mut(),
    ...
    #[test]
    fn aggregate_over_text_index_counts_vertices() {
        use crate::stream::*;
        use mgstorage::storage::Storage;
        unsafe {
            let storage = Box::into_raw(Box::new(Storage::new()));
            ...
            let label_id = (*catalog).label("Article");
            let prop_id = (*catalog).property("content");
            (*storage)
                .create_vertex(&*tx, mgcore::types::Gid::from(1u64))
                .unwrap();
            (*storage)
            ...
            (*storage)
                .vertex_set_property(
                    ...
                    mgcore::types::Gid::from(1u64),
                    prop_id,
                    mgcore::property_value::PropertyValue::String("Rust programming".into()),
                )
                .unwrap();
            ...
            assert_eq!(
                mgp_create_text_index(
                    &graph as *const _ as *mut _,
                    CString::new("Article").unwrap().as_ptr(),
                    prop_list
                ),
                MgpError::NoError
            );
            ...
            let mut result: *mut mgp_map = ptr::null_mut();
            assert_eq!(
                mgp_graph_aggregate_over_text_index(
                    &graph as *const _ as *mut _,
                    CString::new("Article").unwrap().as_ptr(),
                    CString::new("rust").unwrap().as_ptr(),
                    CString::new("count").unwrap().as_ptr(),
                    ptr::null_mut(),
                    &mut result
                ),
                MgpError::NoError
            ...
            let mut count_val: *mut mgp_value = ptr::null_mut();
            mgp_map_at(result, CString::new("count").unwrap().as_ptr(), &mut count_val);
            assert!(!count_val.is_null());
            let mut count = 0i64;
            mgp_value_get_int(count_val, &mut count);
            assert_eq!(count, 1);
    ...
    #[test]
    fn aggregate_over_text_edge_index_counts_edges() {
        use mgstorage::storage::Storage;
        unsafe {
            let storage = Box::into_raw(Box::new(Storage::new()));
            let catalog = Box::into_raw(Box::new(mgcatalog::Catalog::new()));
            ...
            let edge_type_id = (*catalog).edge_type("COMMENTS");
            let prop_id = (*catalog).property("text");

            let v1 = mgcore::types::Gid::from(1u64);
            let v2 = mgcore::types::Gid::from(2u64);
            let e1 = mgcore::types::Gid::from(30u64);
            (*storage).create_vertex(&*tx, v1).unwrap();
            (*storage).create_vertex(&*tx, v2).unwrap();
            (*storage)
                .create_edge(&*tx, e1, v1, v2, edge_type_id)
            ...
            (*storage)
                .edge_set_property(
                    ...
                    e1,
                    prop_id,
                    mgcore::property_value::PropertyValue::String("Great post".into()),
                )
                .unwrap();

            let mut result: *mut mgp_map = ptr::null_mut();
            assert_eq!(
                mgp_graph_aggregate_over_text_edge_index(
                    &graph as *const _ as *mut _,
                    CString::new("COMMENTS").unwrap().as_ptr(),
                    CString::new("great").unwrap().as_ptr(),
                    CString::new("count").unwrap().as_ptr(),
                    ptr::null_mut(),
                    &mut result
                ),
